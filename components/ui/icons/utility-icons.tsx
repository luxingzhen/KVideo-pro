...
export const UtilityIcons = {
    ...
    Wechat: ({ className = "", size = 24 }: IconProps) => (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
            <path d="M8.69 13.538c0-3.666 3.66-6.638 8.173-6.638 4.514 0 8.174 2.972 8.174 6.638 0 3.666-3.66 6.638-8.174 6.638-.89 0-1.742-.116-2.535-.327l-2.824 1.547.76-2.392c-2.196-1.425-3.574-3.567-3.574-5.466zm-7.69 1.258c0-3.14 3.136-5.686 7.005-5.686.33 0 .653.018.97.054a7.72 7.72 0 0 1-.36 2.316c0 .12-.007.238-.007.358 0 4.53 4.298 8.204 9.6 8.204 1.01 0 1.986-.134 2.908-.38l-.046.14c0 3.14-3.137 5.687-7.006 5.687-1.42 0-2.735-.34-3.83-1.045l-3.32 1.332.894-2.05C2.52 22.06 1 20.225 1 18.196c0-1.22.55-2.32 1.455-3.23.06-.06.12-.118.18-.176l-.002.006z" />
        </svg>
    ),

    QQ: ({ className = "", size = 24 }: IconProps) => (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
            <path d="M8.254 7.636c.645-1.956 2.12-3.414 4.318-3.414 2.253 0 3.75 1.55 4.32 3.414.475 1.56.242 4.496-2.09 5.86.375.462.66.924.814 1.254.858-.176 2.376-.198 3.124 1.32.44.88.242 1.848-.154 2.222-.176.154-.374.22-.572.22-.682 0-1.254-.594-1.32-1.232-.044-.374-.154-.528-.198-.572-.374-.352-1.408.022-1.87.594.396.99 1.188 2.2 3.014 2.486 0 .506-.11.968-.33 1.386-.704 1.342-2.486 1.826-4.752 1.826-2.266 0-4.048-.484-4.752-1.826-.22-.418-.33-.88-.33-1.386 1.826-.286 2.618-1.496 3.014-2.486-.462-.572-1.496-.946-1.87-.594-.044.044-.154.198-.198.572-.066.638-.638 1.232-1.32 1.232-.198 0-.396-.066-.572-.22-.396-.374-.594-1.342-.154-2.222.748-1.518 2.266-1.496 3.124-1.32.154-.33.44-.792.814-1.254-2.332-1.364-2.565-4.3-2.09-5.86z" />
        </svg>
    ),
};
