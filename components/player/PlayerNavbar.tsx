...
export function PlayerNavbar({ isPremium }: { isPremium?: boolean }) {
    ...
    return (
        <nav className="sticky top-0 z-50 pt-1 pb-1 px-2 sm:pt-4 sm:pb-2 sm:px-4" style={{ transform: 'translateZ(0)' }}>
            <div className="max-w-7xl mx-auto bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-none md:rounded-[var(--radius-2xl)] shadow-[var(--shadow-sm)] px-3 sm:px-6 py-2 sm:py-4">
